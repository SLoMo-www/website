...
mp4_path = joinpath(@__DIR__, "dog_reach/dog_reach_compiled.mov")
gif_path = joinpath(@__DIR__, "dog_reach/dog_reach_compiled.gif")
convert_video_to_gif(mp4_path, gif_path)